...
HSAs are often called the most tax-efficient savings account available because they offer three distinct tax benefits:

1. **Contributions are pre-tax** - reducing your taxable income in the year you contribute
2. **Growth is tax-free** - interest and investment gains accumulate without being taxed
3. **Withdrawals are tax-free** - when spent on qualified medical expenses

No other common savings or investment account combines all three.
...
- **You can invest it.** Once your balance exceeds a threshold set by your administrator (usually $1,000 to $2,000), you can invest the remainder in mutual funds or ETFs, similar to a 401(k).
- **Withdrawals for any purpose after 65.** Once you turn 65, you can withdraw HSA funds for non-medical expenses without penalty, though you will pay ordinary income tax on those withdrawals, similar to a traditional IRA.
...
- **Use it or lose it.** FSA funds generally expire at the end of your plan year. Many employers offer a grace period of up to 2.5 months or allow a small carryover (up to $640 in 2025), but any remaining funds beyond that are forfeited.
- **Not portable.** If you leave your job, your FSA funds typically stay with the plan.

### 2025 contribution limit

The IRS caps individual Health Care FSA elections at **$3,300 per year**. If you are married, your spouse can also contribute up to $3,300 through their own employer's FSA.
...
Some purchases exist in a gray area: gym memberships, nutritional supplements, saunas, specialty foods, and fitness trackers do not automatically qualify. They **can** qualify when a licensed clinician determines the purchase is medically necessary for treating a specific diagnosed health condition. That is exactly what a Letter of Medical Necessity (LMN) documents.
...
Truemed helps qualified customers use their HSA or FSA on purchases that would not automatically qualify at the pharmacy counter: things like fitness equipment, sleep solutions, supplements, and recovery tools when those purchases are medically appropriate for their health needs.
...
HSAs and FSAs are typically set up through your employer during annual open enrollment, which usually takes place in the fall. If you missed enrollment or are unsure what is available to you:
