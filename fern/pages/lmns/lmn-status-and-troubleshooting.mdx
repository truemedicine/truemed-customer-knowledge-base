...
## LMN rejected — when to escalate

In many cases, retaking the survey with better detail is the right first move. But there are situations where contacting support directly is the better path.

**Contact support if:**

- You've already retaken the survey and received a second rejection.
- You believe the rejection was based on incorrect or incomplete information that you're unable to correct through the survey alone.
- You have a physician's note or existing documentation you'd like to have considered alongside your survey.
- You're unsure whether the product you purchased is eligible for medical necessity documentation at all.

**What to have ready when you contact support:**

- The email address on your Truemed account
- The name of the merchant and product you purchased
- A brief description of your health condition and why you believe the product is medically necessary
- Any relevant documentation (physician's notes, diagnoses, etc.) if applicable

**What support can help with:**

- Reviewing your account and flagging any issues with how the survey was submitted
- Clarifying whether the product category is eligible for LMN documentation
- Facilitating a manual review in appropriate cases

Reach the support team at [support@truemed.com](mailto:support@truemed.com).
