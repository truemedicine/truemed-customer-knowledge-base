...
2. Click **Sign In**
   <img src="./assets/truemed-sign-in.png" alt="Truemed homepage with the Sign In button in the top navigation" title="Truemed Sign In" />
...
5. Your LMN and receipt (if applicable) are available on your **Overview** page. Download your LMN from the **Download Documents** section, and find receipts there or within the individual order in the **Orders** tab
   <img src="./assets/dashboard-orders-recent-activity.png" alt="Orders tab in the Truemed dashboard listing qualifications and orders with Download LMN and Download Receipt buttons" title="Truemed dashboard Orders tab" />
