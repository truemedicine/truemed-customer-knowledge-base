...
Navia 👉 [TrueMed + Navia](/en/articles/5217601)

SA Bank👉 [TrueMed + HSA Bank](/en/articles/5216641)
...
1. **Payroll deductions** – the most common route. Your employer withholds pre-tax dollars each pay period and sends them straight to the administrator.
2. **Direct deposits** – for HSAs only, you can top-up from your bank (still tax-deductible, just less convenient).
3. **Spending** – most admins issue a debit card. Swipe it directly at checkout or submit a claim online with a receipt.
4. **Investing your HSA** – once your cash balance hits the admin’s threshold (often $1,000–$2,000), you can move the extra into mutual funds or ETFs tax-free.
***
## 5. Unlocking Extra Eligibility — How the **Letter of Medical Necessity (LMN)** Works 🩺

**Automatically eligible (no LMN required)**

• Bandages, adhesive strips, gauze

• Doctor & dentist copays

• Prescription meds & insulin

• Contact-lens solution

• Blood-pressure monitor

**Potentially eligible — requires an LMN**

• Gym or fitness memberships

• Continuous-glucose monitors for wellness tracking

• Infrared or traditional saunas

• Massage therapy or PT devices

• Certain supplements (e.g., higher-dose vitamin D for deficiency)
...
1. **Matching you with a licensed clinician** who can review your health goals and decide whether an LMN is appropriate.
2. **Issuing a signed LMN** in minutes if you qualify—ready to download, save, and submit to your administrator.
3. **Guiding you through claims** so the paperwork actually passes muster.
***
...
Still have questions? Search our Help Center or email [**support@truemed.com**](mailto:support@truemed.com)—we’re here to help you make the most of every pre-tax dollar.
