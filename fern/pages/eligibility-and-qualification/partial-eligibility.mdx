...
For example: a mattress with advanced cooling features may only be eligible for the portion of its cost that aligns with a standard mattress. The cooling technology itself, which goes beyond basic therapeutic function, would be considered ineligible.
...
Truemed's provider team determines the eligible portion of a purchase by comparing the product to a standard, comparable version of the same item. This is called the **comparable item** approach.
...
- **Treadmills and exercise equipment:** A basic treadmill recommended for cardiac rehabilitation or physical therapy may qualify. A high-end model with an entertainment system, interactive display, or designer frame would likely have the premium portion excluded.
- **Air purifiers:** A standard HEPA air purifier recommended for asthma or allergy management may qualify. A model with smart home integration, designer housing, or advanced air quality analytics may have those features treated as ineligible.
...
For example: if you're purchasing a mattress for $2,791.58 and the eligible amount is $2,459.58, you'll pay the full $2,791.58 at checkout, but you can seek reimbursement for up to $2,459.58 from your HSA/FSA.
...
- The ineligible portion is paid like any other purchase and is not reimbursable through HSA/FSA funds
