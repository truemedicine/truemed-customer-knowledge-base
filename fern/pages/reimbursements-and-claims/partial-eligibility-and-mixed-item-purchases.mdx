...
- **Cost comparison document (if requested).** Some administrators require a cost comparison showing how the eligible amount was calculated relative to a base model. For common products, Truemed automatically includes this documentation. If your administrator asks for it and you do not have it, contact [support@truemed.com](mailto:support@truemed.com) with your order details and the team will send it to you.
