...
<img src="./assets/dashboard-orders-recent-activity.png" alt="Orders tab in the Truemed dashboard showing an order with a Download Receipt button" title="Download your receipt from the Orders tab" />
