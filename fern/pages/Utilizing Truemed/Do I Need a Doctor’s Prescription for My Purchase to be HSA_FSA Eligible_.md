...
- **Clinical Rationale:**
  The LMN must clearly explain how the product is “primarily for” the prevention or treatment of a specific condition.
- **Diagnosis by a Qualified Provider:**
  Your condition must be diagnosed by a healthcare provider who is qualified to make that determination.
...
- **Demonstrates Medical Necessity:**
  Clearly connects your diagnosed condition with the recommended use of the product.
...
1. **Alert Your Administrator:**
   Inform them that, under IRS guidance, a valid LMN is sufficient for HSA/FSA reimbursement when it comes to health purchases for medically necessary interventions.
