...
Truemed only processes HSA/FSA payments for items that are medically eligible. When you reach checkout, your cart is reviewed in real time against Truemed's eligibility criteria. If the system flags your cart as ineligible, your HSA/FSA card won't be charged, regardless of your account balance.

A few things to check:

- **Did you complete the qualification survey?** Some products require you to complete a short medical qualification survey before your HSA/FSA card can be used. If you skipped it or didn't finish it, that could be the reason for the decline.
- **Is this product covered through Truemed?** Not every product sold by a Truemed merchant partner is eligible. Search for the product on [truemed.com](https://truemed.com) to confirm it falls into a covered health category.
- **Is this merchant integrated with Truemed?** If you're checking out on a site that isn't a Truemed merchant partner, your HSA/FSA card won't work through Truemed's system.
...
- The product requires a Letter of Medical Necessity (LMN) that hasn't been issued yet
- Your qualification survey indicated a condition that doesn't support eligibility for that specific item

**What to do:**

- Double-check the product's eligibility on [truemed.com](https://truemed.com) before completing checkout.
...
- If you need the item now, you can complete the purchase with a regular debit or credit card and explore reimbursement options separately.
...
- Some merchants support this split payment flow natively. Others don't. If the split payment option isn't shown, it isn't available for that merchant.
...
- Your card has a daily spending limit or per-transaction cap that the purchase exceeded.
...
- **Card network restrictions.** Some HSA/FSA cards are restricted to specific merchant category codes (MCCs). If the merchant's MCC doesn't match what your card issuer expects for healthcare purchases, the card may be declined automatically.
